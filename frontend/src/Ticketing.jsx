  ...
  const VenueScanner = () => (
    <div className="flex flex-col h-[calc(100vh-70px)] bg-black">
      <div className="flex-1 flex items-center justify-center relative overflow-hidden">
        ...
        {/* Background Effect */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-slate-800 via-black to-black"></div>
      </div>
