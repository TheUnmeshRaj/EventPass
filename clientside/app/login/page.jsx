...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-emerald-900 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="max-w-4xl w-full grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden md:flex flex-col gap-6 justify-center px-8">
          <div className="bg-white/5 backdrop-blur-md px-5 py-4 rounded-xl border border-white/5">
            <h2 className="text-3xl font-extrabold text-white tracking-tight">Satya<span className="text-emerald-300">Ticketing</span></h2>
            <p className="mt-2 text-slate-200/80">Secure, biometric-bound tickets — built on-chain.</p>
          </div>
          ...
          <div className="bg-white/4 p-6 rounded-2xl border border-white/6 shadow-inner">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 bg-emerald-400/20 rounded-lg flex items-center justify-center">
                <svg width="26" height="26" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3 7a3 3 0 0 1 3-3h12a3 3 0 0 1 3 3v4a3 3 0 0 1-3 3h-1v2a3 3 0 0 1-3 3H9a3 3 0 0 1-3-3v-2H5a3 3 0 0 1-3-3V7z" stroke="white" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/></svg>
              </div>
              <div>
                <div className="text-sm text-slate-200/90 font-semibold">Trusted & Private</div>
                <div className="text-xs text-slate-300/80">Biometric hashes, not images. Decentralized ownership.</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/6 backdrop-blur-lg border border-white/8 rounded-2xl shadow-xl p-8">
          <div className="mb-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-slate-200/80 mt-1">Sign in to manage your tickets securely</p>
              </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="text-xs text-slate-300">By signing in you agree to the demo terms.</div>
              <div className="text-xs text-slate-300 hover:text-white cursor-pointer">Forgot?</div>
            </div>
